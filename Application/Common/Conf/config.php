...
if(ENV=="product"){
    $_server_db = [
        ...
        'alipay'   =>array(
            ...
            'notify_url'=>'http://rummery.wowoyoo.com/home/index/testNotifyurl',
            //这里是页面跳转通知url，提交到项目的Pay控制器的returnurl方法；
            'return_url'=>'http://rummery.wowoyoo.com/home/index/testReturnurl',
        ),
    ];
}else{
    $_server_db = [
...
return array_merge($_config,$_server_db);